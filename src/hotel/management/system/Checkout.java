...
public class Checkout extends JFrame implements ActionListener {
    ...
    Checkout() {
        ...
        // Load initial details for selected customer
        loadCustomerDetails();

        // Add listener to update details dynamically
    ...
    // Method to load selected customer details
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == checkout) {
            ...
            String roomNum = lblroomnumber.getText();

            String query1 = "delete from customer where number='" + customerId + "'";
            String query2 = "update room set availability='Available' where roomnumber='" + roomNum + "'";
